...
export default function BlogPage({ posts }) {
  ...
  return (
    <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-0">
      <h1 className="text-2xl text-gray-600 font-serif mb-6 font-bold">Notes</h1>
      <div>
        <input
          type="text"
          value={searchValue}
      ...
      <div className="flex space-x-5 justify-center items-center mt-10">
        ...
        <div>
          <button
            ...
            className="bg-gray-700 w-20 text-white px-3 py-1 rounded-md disabled:bg-gray-400 disabled:text-gray-800">
            Next
          </button>
        </div>
